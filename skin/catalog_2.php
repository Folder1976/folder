    ...
    <div class="medium-17 columns section__col-content">
        ...
        <div class="row sort-by">
            ...
            <div class="medium-10 columns sort-by__col text-right">
                ...
                <a href="<?php echo $_SERVER['REDIRECT_URL'].'?step=15';?>"><span class="sort-by__link <?php if($step == 15) echo 'sort-by__link_active';?>">15</span></a>
                <a href="<?php echo $_SERVER['REDIRECT_URL'].'?step=30';?>"><span class="sort-by__link <?php if($step == 30) echo 'sort-by__link_active';?>">30</span></a>
                <a href="<?php echo $_SERVER['REDIRECT_URL'].'?step=45';?>"><span class="sort-by__link <?php if($step == 45) echo 'sort-by__link_active';?>">45</span></a>
                <a href="<?php echo $_SERVER['REDIRECT_URL'].'?step=1000';?>"><span class="sort-by__link <?php if($step == 1000) echo 'sort-by__link_active';?>">Все</span></a>
            </div>
        </div>
                                    ...
                                    <div class="c-product__row c-product__row_price">
                                        <div class="row">
                                            <div class="small-8 columns">
                                                ...
                                                <span class="c-product__price"><?php echo isset($product['price']) ? $product['price'] : '0';?> ₽</span>
        ...
        <div class="pager">
                ...
                <?php if($page > 1) {?>
                        <a href="<?php echo $_SERVER['REDIRECT_URL'].'?page=1&step='.$step;?>" class="pager__item pager__item_prev"><span class="fa fa-angle-left"></span></a>
                <?php } ?>
                
                <?php for($x = 1;$x <= $end; $x++){ ?>
                        <?php if($x == $page){ ?>
                                <a href="<?php echo $_SERVER['REDIRECT_URL'].'?page='.$x.'&step='.$step;?>" class="pager__item pager__item_current"><?php echo $x; ?></a>
                        <?php }else{ ?>
                                <a href="<?php echo $_SERVER['REDIRECT_URL'].'?page='.$x.'&step='.$step;?>" class="pager__item"><?php echo $x; ?></a>
                        <?php } ?>
                <?php } ?>
        
                <?php if($page < $end) {?>
                    <a href="<?php echo $_SERVER['REDIRECT_URL'].'?page='.$end.'&step='.$step;?>" class="pager__item pager__item_next"><span class="fa fa-angle-right"></span></a>
                <?php } ?>
        </div>
