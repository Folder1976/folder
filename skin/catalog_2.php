...
<div class="page">
    ...
    <div class="small-24 columns">
        <div class="breadcrumbs">
            ...
            <?php if(isset($data['breadcrumb']) AND is_array($data['breadcrumb'])){ ?>
                <?php foreach($data['breadcrumb'] as $id => $breadcrumb){ ?>
                        <?php if($id != 0 OR isset($_POST['brand_code'])){ ?>
                ...
                <?php if(isset($data['products'])) { $count=1;?>
                        <?php foreach($data['products'] as $artkl => $product){ ?>
                                ...
                                <?php if($count++ > 1) echo '-->'; ?><div class="c-product">
                                    ...
                                    <div class="c-product__row product_colors" data-id="<?php echo $artkl; ?>" id="colors_<?php echo $artkl; ?>">
