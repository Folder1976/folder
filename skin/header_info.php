                    ...
                    <div class="header__table-cell">
                        <ul class="h-menu">
                            ...
                            <li class="h-menu__item">
                                <a href="news.html" class="h-menu__link">Обзоры</a></li>
                            
                            <li class="h-menu__item">
                                <a href="help.html" class="h-menu__link">Как выбрать размер</a></li>
                            
                            <li class="h-menu__item">
                                <a href="dostavka.html" class="h-menu__link">Оплата и доставка</a></li>
                    ...
                    <div class="header__table-cell medium-10">
                        <div class="h-cart">
                               <div class="h-cart__row">
                                    <span class="h-cart__ico fa fa-shopping-cart"></span><span class="h-cart__total"><span class="num-cart__total"><?php if($order_sum > 0){ echo $order_sum; } ?></span> ₽</span>
                                </div>
                                <div class="h-cart__row">
