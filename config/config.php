...
define("HOST_URL", "http://localhost/folder.com.ua");
define("HOST_URL_ST", "localhost/folder.com.ua");
...
$setup = array(
                ...
                'email name' => 'Folder',
                'email login' => 'folder.list@gmail.com',
                'email pass' => 'foldersturm2015',
                'email port' => '465',
                ...
                'load patch' => '/var/www/folder.com.ua/resources/',
                ...
                'tovar name sep' => '||',
                'tovar photo patch' => '/var/www/folder.com.ua/resources/products/',
                'web default price' => '2',
