...
define("HOST_URL", "http://localhost/armma.ru");
define("HOST_URL_ST", "localhost/armma.ru");

define('SKIN_URL','http://localhost/armma.ru/skin/');
define('SKIN_PATH','/var/www/armma.ru/skin/');
...
$setup = array(
                ...
                'load patch' => '/var/www/armma.ru/resources/',
                ...
                'tovar name sep' => '||',
                'tovar photo patch' => '/var/www/armma.ru/resources/products/',
                'web default price' => '2',
