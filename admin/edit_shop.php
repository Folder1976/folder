...
//==================================SETUP=MENU==========================================
$count = 0;
$this_page_name = "edit_shop.php";
$this_table_id_name = "shop_id";
$this_table_name_name = "shop_name_".$_SESSION[BASE.'lang'];

$this_table_name = "tbl_shop";
...
echo "\n<input type='text'  style='width:400px'  name='shop_name_1' value='" . mysql_result($ver,0,"shop_name_1") . "'/></td></tr>";

echo "\n<tr><td>",$m_setup['menu name1']," UKR:</td><td>"; # Group name 1
echo "\n<input type='text'  style='width:400px'  name='shop_name_2' value='" . mysql_result($ver,0,"shop_name_2") . "'/></td></tr>";

echo "\n<tr><td>",$m_setup['menu name1']," US:</td><td>"; # Group name 1
echo "\n<input type='text'  style='width:400px'  name='shop_name_3' value='" . mysql_result($ver,0,"shop_name_3") . "'/></td></tr>";

echo "\n<tr><td>",$m_setup['menu sort'],":</td><td>"; # Group name 1
echo "\n<input type='text'  style='width:40px'  name='shop_sort' value='" . mysql_result($ver,0,"shop_sort") . "'/></td></tr>";
