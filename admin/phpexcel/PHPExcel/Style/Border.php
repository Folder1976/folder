 ...
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Style_Border extends _Style_Supervisor implements _IComparable
{
	/* Border style */
	 ...
	 * @var string
	 */
	protected $_borderStyle	= _Style_Border::BORDER_NONE;
	...
	public function __construct($isSupervisor = FALSE, $isConditional = FALSE)
	{
		...
		// Initialise values
		$this->_color	= new _Style_Color(_Style_Color::COLOR_BLACK, $isSupervisor);
	...
	public function getSharedComponent()
	{
		switch ($this->_parentPropertyName) {
			...
			case '_outline':
			case '_vertical':
				throw new _Exception('Cannot get shared component for a pseudo-border.');
				break;
			case '_bottom':
	 ...
	 *
	 * <code>
	 * $obj->getActiveSheet()->getStyle('B2')->getBorders()->getTop()->applyFromArray(
	 *		array(
	 ...
	 *							When passing a boolean, FALSE equates _Style_Border::BORDER_NONE
	 *								and TRUE to _Style_Border::BORDER_MEDIUM
	 * @return _Style_Border
	 */
	public function setBorderStyle($pValue = _Style_Border::BORDER_NONE) {

		if (empty($pValue)) {
			$pValue = _Style_Border::BORDER_NONE;
		} elseif(is_bool($pValue) && $pValue) {
			$pValue = _Style_Border::BORDER_MEDIUM;
		}
		if ($this->_isSupervisor) {
	 ...
	 * Set Border Color
	 *
	 * @param	_Style_Color $pValue
	 * @throws	_Exception
	 * @return _Style_Border
	 */
	public function setColor(_Style_Color $pValue = null) {
