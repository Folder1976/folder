 ...
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Style_Fill extends _Style_Supervisor implements _IComparable
{
	/* Fill types */
	 ...
	 * @var string
	 */
	protected $_fillType	= _Style_Fill::FILL_NONE;
	...
	public function __construct($isSupervisor = FALSE, $isConditional = FALSE)
	{
		...
		$this->_startColor			= new _Style_Color(_Style_Color::COLOR_WHITE, $isSupervisor, $isConditional);
		$this->_endColor			= new _Style_Color(_Style_Color::COLOR_BLACK, $isSupervisor, $isConditional);
	 ...
	 *
	 * <code>
	 * $obj->getActiveSheet()->getStyle('B2')->getFill()->applyFromArray(
	 *		array(
	 *			'type'	   => _Style_Fill::FILL_GRADIENT_LINEAR,
	 *			'rotation'   => 0,
	 *			'startcolor' => array(
	 *				'rgb' => '000000'
	 *			),
	 ...
	 * Set Fill Type
	 *
	 * @param string $pValue	_Style_Fill fill type
	 * @return _Style_Fill
	 */
	public function setFillType($pValue = _Style_Fill::FILL_NONE) {
		if ($this->_isSupervisor) {
	 ...
	 * @return _Style_Fill
	 */
	public function setStartColor(_Style_Color $pValue = null) {
	 ...
	 * @return _Style_Fill
	 */
	public function setEndColor(_Style_Color $pValue = null) {
		// make sure parameter is a real color and not a supervisor
		$color = $pValue->getIsSupervisor() ? $pValue->getSharedComponent() : $pValue;
