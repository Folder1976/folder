 ...
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Style_Font extends _Style_Supervisor implements _IComparable
{
	/* Underline types */
	...
	public function __construct($isSupervisor = FALSE, $isConditional = FALSE)
	{
		...
		if ($isConditional) {
			...
			$this->_color			= new _Style_Color(_Style_Color::COLOR_BLACK, $isSupervisor, $isConditional);
		} else {
	 ...
	 *
	 * <code>
	 * $obj->getActiveSheet()->getStyle('B2')->getFont()->applyFromArray(
	 *		array(
	 *			'name'		=> 'Arial',
	 *			'bold'		=> TRUE,
	 *			'italic'	=> FALSE,
	 ...
	 * Set Underline
	 *
	 * @param string|boolean $pValue	_Style_Font underline type
