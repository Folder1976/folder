 ...
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Style_Color extends _Style_Supervisor implements _IComparable
{
	/* Colors */
	 ...
	 *										its ramifications are
	 */
	public function __construct($pARGB = _Style_Color::COLOR_BLACK, $isSupervisor = FALSE, $isConditional = FALSE)
	{
		//	Supervisor?
	 ...
	 *
	 * <code>
	 * $obj->getActiveSheet()->getStyle('B2')->getFont()->getColor()->applyFromArray( array('rgb' => '808080') );
	 * </code>
	 *
	 ...
	 * @return _Style_Color
	 */
	public function setARGB($pValue = _Style_Color::COLOR_BLACK) {
		if ($pValue == '') {
			$pValue = _Style_Color::COLOR_BLACK;
		}
		if ($this->_isSupervisor) {
	...
	public static function indexedColor($pIndex, $background=FALSE) {
		...
		if (array_key_exists($pIndex, self::$_indexedColors)) {
			return new _Style_Color(self::$_indexedColors[$pIndex]);
		}

		if ($background) {
			return new _Style_Color('FFFFFFFF');
		}
		return new _Style_Color('FF000000');
	}
