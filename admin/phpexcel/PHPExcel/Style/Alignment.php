 ...
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Style_Alignment extends _Style_Supervisor implements _IComparable
{
	 ...
	 * @var string
	 */
	protected $_horizontal	= _Style_Alignment::HORIZONTAL_GENERAL;
	 ...
	 * @var string
	 */
	protected $_vertical		= _Style_Alignment::VERTICAL_BOTTOM;
	 ...
	 *
	 * <code>
	 * $obj->getActiveSheet()->getStyle('B2')->getAlignment()->applyFromArray(
	 *		array(
	 *			'horizontal' => _Style_Alignment::HORIZONTAL_CENTER,
	 *			'vertical'   => _Style_Alignment::VERTICAL_CENTER,
	 *			'rotation'   => 0,
	 *			'wrap'			=> TRUE
	 *		)
	 * );
	 ...
	 * @return _Style_Alignment
	 */
	public function setHorizontal($pValue = _Style_Alignment::HORIZONTAL_GENERAL) {
		if ($pValue == '') {
			$pValue = _Style_Alignment::HORIZONTAL_GENERAL;
		}
	 ...
	 * @return _Style_Alignment
	 */
	public function setVertical($pValue = _Style_Alignment::VERTICAL_BOTTOM) {
		if ($pValue == '') {
			$pValue = _Style_Alignment::VERTICAL_BOTTOM;
		}
	...
	public function setTextRotation($pValue = 0) {
		...
		if ( ($pValue >= -90 && $pValue <= 90) || $pValue == -165 ) {
			...
			throw new _Exception("Text rotation should be a value between -90 and 90.");
		}
