 ...
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Style_NumberFormat extends _Style_Supervisor implements _IComparable
{
	/* Pre-defined formats */
	 ...
	 * @var string
	 */
	protected $_formatCode	=	_Style_NumberFormat::FORMAT_GENERAL;
	...
	/**
	 * Create a new _Style_NumberFormat
	 *
	 ...
	 *
	 * <code>
	 * $obj->getActiveSheet()->getStyle('B2')->getNumberFormat()->applyFromArray(
	 *		array(
	 *			'code' => _Style_NumberFormat::FORMAT_CURRENCY_EUR_SIMPLE
	 *		)
	 * );
	 * </code>
	 *
	 ...
	 * @return _Style_NumberFormat
	 */
	public function setFormatCode($pValue = _Style_NumberFormat::FORMAT_GENERAL)
	{
		if ($pValue == '') {
			$pValue = _Style_NumberFormat::FORMAT_GENERAL;
		}
		if ($this->_isSupervisor) {
	...
	private static function fillBuiltInFormatCodes()
	{
		...
		if (is_null(self::$_builtInFormats)) {
			...
			// General
			self::$_builtInFormats[0] = _Style_NumberFormat::FORMAT_GENERAL;
	...
	private static function _formatAsDate(&$value, &$format)
	{
		...
		$dateObj = _Shared_Date::ExcelToPHPObject($value);
	...
	private static function _formatAsFraction(&$value, &$format)
	{
		...
		$GCD = _Calculation_MathTrig::GCD($decimalPart,$decimalDivisor);
	 ...
	 */
	public static function toFormattedString($value = '0', $format = _Style_NumberFormat::FORMAT_GENERAL, $callBack = null)
	{
		...
		if (($format === _Style_NumberFormat::FORMAT_GENERAL) || ($format === _Style_NumberFormat::FORMAT_TEXT)) {
			return $value;
		}
					...
					if (preg_match($number_regex, $m, $matches)) {
						...
						if ($useThousands) {
							$value = number_format(
										$value
										, strlen($right)
										, _Shared_String::getDecimalSeparator()
										, _Shared_String::getThousandsSeparator()
									);
