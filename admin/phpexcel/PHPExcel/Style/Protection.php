 ...
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Style_Protection extends _Style_Supervisor implements _IComparable
{
	/** Protection styles */
	...
	/**
     * Create a new _Style_Protection
	 *
     ...
     *
     * <code>
     * $obj->getActiveSheet()->getStyle('B2')->getLocked()->applyFromArray(
     *		array(
     *			'locked' => TRUE,
     *			'hidden' => FALSE
     *		)
