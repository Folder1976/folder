...
require_once PHPEXCEL_ROOT . '/Shared/trend/bestFitClass.php';
require_once PHPEXCEL_ROOT . '/Shared/JAMA/Matrix.php';


/**
 * _Polynomial_Best_Fit
 *
 * @category   
 * @package    _Shared_Trend
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Polynomial_Best_Fit extends _Best_Fit
{
	/**
