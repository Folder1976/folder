...
class _Shared_String
{
	...
	public static function convertToNumberIfFraction(&$operand) {
		if (preg_match('/^'.self::STRING_REGEXP_FRACTION.'$/i', $operand, $match)) {
			...
			$operand = _Calculation::getInstance()->_calculateFormulaValue($fractionFormula);
			return true;
		}
		return false;
	...
	/**
	 * Set the decimal separator. Only used by _Style_NumberFormat::toFormattedString()
	 * to format output by _Writer_HTML and _Writer_PDF
	 *
	...
	/**
	 * Set the thousands separator. Only used by _Style_NumberFormat::toFormattedString()
	 * to format output by _Writer_HTML and _Writer_PDF
	 *
	...
	/**
	 * Set the currency code. Only used by _Style_NumberFormat::toFormattedString()
	 *		to format output by _Writer_HTML and _Writer_PDF
	 *
