...
class _Shared_Date
{
	...
	public static function ExcelToPHP($dateValue = 0, $adjustToTimezone = FALSE, $timezone = NULL) {
		...
		$timezoneAdjustment = ($adjustToTimezone) ?
		    _Shared_TimeZone::getTimezoneAdjustment($timezone, $returnValue) :
		    0;
	 ...
	 * @return	 boolean
	 */
	public static function isDateTime(_Cell $pCell) {
	 ...
	 *
	 * @param	 _Style_NumberFormat	$pFormat
	 * @return	 boolean
	 */
	public static function isDateTimeFormat(_Style_NumberFormat $pFormat) {
	...
	public static function isDateTimeFormatCode($pFormatCode = '') {
		...
		switch ($pFormatCode) {
			...
			case _Style_NumberFormat::FORMAT_GENERAL:
				return FALSE;
			//	Explicitly defined date formats
			case _Style_NumberFormat::FORMAT_DATE_YYYYMMDD:
			case _Style_NumberFormat::FORMAT_DATE_YYYYMMDD2:
			case _Style_NumberFormat::FORMAT_DATE_DDMMYYYY:
			case _Style_NumberFormat::FORMAT_DATE_DMYSLASH:
			case _Style_NumberFormat::FORMAT_DATE_DMYMINUS:
			case _Style_NumberFormat::FORMAT_DATE_DMMINUS:
			case _Style_NumberFormat::FORMAT_DATE_MYMINUS:
			case _Style_NumberFormat::FORMAT_DATE_DATETIME:
			case _Style_NumberFormat::FORMAT_DATE_TIME1:
			case _Style_NumberFormat::FORMAT_DATE_TIME2:
			case _Style_NumberFormat::FORMAT_DATE_TIME3:
			case _Style_NumberFormat::FORMAT_DATE_TIME4:
			case _Style_NumberFormat::FORMAT_DATE_TIME5:
			case _Style_NumberFormat::FORMAT_DATE_TIME6:
			case _Style_NumberFormat::FORMAT_DATE_TIME7:
			case _Style_NumberFormat::FORMAT_DATE_TIME8:
			case _Style_NumberFormat::FORMAT_DATE_YYYYMMDDSLASH:
			case _Style_NumberFormat::FORMAT_DATE_XLSX14:
			case _Style_NumberFormat::FORMAT_DATE_XLSX15:
			case _Style_NumberFormat::FORMAT_DATE_XLSX16:
			case _Style_NumberFormat::FORMAT_DATE_XLSX17:
			case _Style_NumberFormat::FORMAT_DATE_XLSX22:
				return TRUE;
		}
	...
	public static function stringToExcel($dateValue = '') {
		...
		$dateValueNew = _Calculation_DateTime::DATEVALUE($dateValue);

		if ($dateValueNew === _Calculation_Functions::VALUE()) {
			return FALSE;
		} else {
			if (strpos($dateValue, ':') !== FALSE) {
				$timeValue = _Calculation_DateTime::TIMEVALUE($dateValue);
				if ($timeValue === _Calculation_Functions::VALUE()) {
					return FALSE;
				}
