...
/**
 * _Shared_Escher_DggContainer
 *
 * @category   
 * @package    _Shared_Escher
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Shared_Escher_DggContainer
{
	/**
	 ...
	 *
	 * @return _Shared_Escher_DggContainer_BstoreContainer
	 */
	 ...
	 *
	 * @param _Shared_Escher_DggContainer_BstoreContainer $bstoreContainer
	 */
