...
/**
 * _Shared_Escher_DgContainer_SpgrContainer_SpContainer
 *
 * @category   
 * @package    _Shared_Escher
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Shared_Escher_DgContainer_SpgrContainer_SpContainer
{
	/**
	 ...
	 *
	 * @return _Shared_Escher_DgContainer_SpgrContainer
	 */
	...
	public function getNestingLevel()
	{
		...
		while ($parent instanceof _Shared_Escher_DgContainer_SpgrContainer) {
			++$nestingLevel;
