...
if (!defined('PCLZIP_TEMPORARY_DIR')) {
	define('PCLZIP_TEMPORARY_DIR', _Shared_File::sys_get_temp_dir());
}
require_once PHPEXCEL_ROOT . '/Shared/PCLZip/pclzip.lib.php';
...
class _Shared_ZipArchive
{
	...
	public function addFromString($localname, $contents)
	{
		...
		if ($res == 0) {
			throw new _Writer_Exception("Error zipping files : " . $this->_zip->errorInfo(true));
		}
