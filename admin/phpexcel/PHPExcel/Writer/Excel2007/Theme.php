...
/**
 * _Writer_Excel2007_Theme
 *
 * @category   
 * @package    _Writer_Excel2007
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Writer_Excel2007_Theme extends _Writer_Excel2007_WriterPart
{
	/**
	 ...
	 */
	public function writeTheme( $p = null)
	{
			// Create XML writer
			$objWriter = null;
	 ...
	 *
	 * @param 	_Shared_XMLWriter	$objWriter
