...
/**
 * _Writer_Excel2007_Comments
 *
 * @category   
 * @package    _Writer_Excel2007
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Writer_Excel2007_Comments extends _Writer_Excel2007_WriterPart
{
	/**
	 ...
	 */
	public function writeComments(_Worksheet $pWorksheet = null)
	{
		// Create XML writer
		$objWriter = null;
	 ...
	 * @param 	_Comment				$pComment			Comment
	 * @param	array							$pAuthors			Array of authors
	 * @throws 	_Writer_Exception
	 */
	public function _writeComment(_Shared_XMLWriter $objWriter = null, $pCellReference = 'A1', _Comment $pComment = null, $pAuthors = null)
	{
		// comment
	 ...
	 * @throws 	_Writer_Exception
	 */
	public function writeVMLComments(_Worksheet $pWorksheet = null)
	{
		// Create XML writer
		$objWriter = null;
		if ($this->getParentWriter()->getUseDiskCaching()) {
	 ...
	 * @throws 	_Writer_Exception
	 */
	public function _writeVMLComment(_Shared_XMLWriter $objWriter = null, $pCellReference = 'A1', _Comment $pComment = null)
	{
 		// Metadata
 		list($column, $row) = _Cell::coordinateFromString($pCellReference);
 		$column = _Cell::columnIndexFromString($column);
 		$id = 1024 + $column + $row;
 		$id = substr($id, 0, 4);
