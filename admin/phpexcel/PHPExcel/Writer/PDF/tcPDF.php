...
$pdfRendererClassFile = _Settings::getPdfRendererPath() . '/tcpdf.php';
if (file_exists($pdfRendererClassFile)) {
    $k_path_url = _Settings::getPdfRendererPath();
 ...
 *  @copyright   Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Writer_PDF_tcPDF extends _Writer_PDF_Core implements _Writer_IWriter
{
    /**
    ...
    public function save($pFilename = NULL)
    {
        ...
        if (!is_null($this->getOrientation())) {
            $orientation = ($this->getOrientation() == _Worksheet_PageSetup::ORIENTATION_LANDSCAPE)
                ? 'L'
                : 'P';
        }
        //  Override Paper Size
