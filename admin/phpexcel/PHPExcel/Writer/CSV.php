 ...
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Writer_CSV extends _Writer_Abstract implements _Writer_IWriter {
	/**
	 *  object
	 *
	 * @var 
	...
	private function _writeLine($pFileHandle = null, $pValues = null) {
		if (is_array($pValues)) {
			...
			throw new _Writer_Exception("Invalid data row passed to CSV writer.");
		}
	}
