...
class _Writer_Excel5_Font
{
	 ...
	 */
	public function __construct(_Style_Font $font = null)
	{
	...
	public function writeFont()
	{
		...
		$bCharSet = _Shared_Font::getCharsetFromFontName($this->_font->getName()); // Character set
		...
		$data .= _Shared_String::UTF8toBIFF8UnicodeShort($this->_font->getName());
	 ...
	 *
	 */
	private static $_mapUnderline = array(	_Style_Font::UNDERLINE_NONE					=> 0x00,
											_Style_Font::UNDERLINE_SINGLE				=> 0x01,
											_Style_Font::UNDERLINE_DOUBLE				=> 0x02,
											_Style_Font::UNDERLINE_SINGLEACCOUNTING		=> 0x21,
											_Style_Font::UNDERLINE_DOUBLEACCOUNTING		=> 0x22,
										 );
	/**
	 * Map underline
	 *
