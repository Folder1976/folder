...
class _Writer_Excel5_Xf
{
	...
	*/
	 ...
	 *
	 * @access public
	 * @param _Style	The XF format
	 */
	public function __construct(_Style $style = null)
	{
	...
	function writeXf()
	{
		...
		$diag_tl_to_rb = $diagonalDirection == _Style_Borders::DIAGONAL_BOTH
							|| $diagonalDirection == _Style_Borders::DIAGONAL_DOWN;
		$diag_tr_to_lb = $diagonalDirection == _Style_Borders::DIAGONAL_BOTH
							|| $diagonalDirection == _Style_Borders::DIAGONAL_UP;
	 ...
	 *
	 */
	private static $_mapBorderStyle = array	( _Style_Border::BORDER_NONE				=> 0x00,
											  _Style_Border::BORDER_THIN				=> 0x01,
											  _Style_Border::BORDER_MEDIUM				=> 0x02,
											  _Style_Border::BORDER_DASHED				=> 0x03,
											  _Style_Border::BORDER_DOTTED				=> 0x04,
											  _Style_Border::BORDER_THICK				=> 0x05,
											  _Style_Border::BORDER_DOUBLE				=> 0x06,
											  _Style_Border::BORDER_HAIR				=> 0x07,
											  _Style_Border::BORDER_MEDIUMDASHED		=> 0x08,
											  _Style_Border::BORDER_DASHDOT				=> 0x09,
											  _Style_Border::BORDER_MEDIUMDASHDOT		=> 0x0A,
											  _Style_Border::BORDER_DASHDOTDOT			=> 0x0B,
											  _Style_Border::BORDER_MEDIUMDASHDOTDOT	=> 0x0C,
											  _Style_Border::BORDER_SLANTDASHDOT		=> 0x0D,
											);
	 ...
	 *
	 */
	private static $_mapFillType = array( _Style_Fill::FILL_NONE					=> 0x00,
										  _Style_Fill::FILL_SOLID					=> 0x01,
										  _Style_Fill::FILL_PATTERN_MEDIUMGRAY		=> 0x02,
										  _Style_Fill::FILL_PATTERN_DARKGRAY		=> 0x03,
										  _Style_Fill::FILL_PATTERN_LIGHTGRAY		=> 0x04,
										  _Style_Fill::FILL_PATTERN_DARKHORIZONTAL	=> 0x05,
										  _Style_Fill::FILL_PATTERN_DARKVERTICAL	=> 0x06,
										  _Style_Fill::FILL_PATTERN_DARKDOWN		=> 0x07,
										  _Style_Fill::FILL_PATTERN_DARKUP			=> 0x08,
										  _Style_Fill::FILL_PATTERN_DARKGRID		=> 0x09,
										  _Style_Fill::FILL_PATTERN_DARKTRELLIS		=> 0x0A,
										  _Style_Fill::FILL_PATTERN_LIGHTHORIZONTAL	=> 0x0B,
										  _Style_Fill::FILL_PATTERN_LIGHTVERTICAL	=> 0x0C,
										  _Style_Fill::FILL_PATTERN_LIGHTDOWN		=> 0x0D,
										  _Style_Fill::FILL_PATTERN_LIGHTUP			=> 0x0E,
										  _Style_Fill::FILL_PATTERN_LIGHTGRID		=> 0x0F,
										  _Style_Fill::FILL_PATTERN_LIGHTTRELLIS	=> 0x10,
										  _Style_Fill::FILL_PATTERN_GRAY125			=> 0x11,
										  _Style_Fill::FILL_PATTERN_GRAY0625		=> 0x12,
										  _Style_Fill::FILL_GRADIENT_LINEAR			=> 0x00,	// does not exist in BIFF8
										  _Style_Fill::FILL_GRADIENT_PATH			=> 0x00,	// does not exist in BIFF8
										);
	/**
	 * Map fill type
	 *
	 ...
	 *
	 */
	private static $_mapHAlign = array( _Style_Alignment::HORIZONTAL_GENERAL			=> 0,
										_Style_Alignment::HORIZONTAL_LEFT				=> 1,
										_Style_Alignment::HORIZONTAL_CENTER				=> 2,
										_Style_Alignment::HORIZONTAL_RIGHT				=> 3,
										_Style_Alignment::HORIZONTAL_JUSTIFY			=> 5,
										_Style_Alignment::HORIZONTAL_CENTER_CONTINUOUS	=> 6,
									  );
	/**
	 ...
	 *
	 */
	private static $_mapVAlign = array( _Style_Alignment::VERTICAL_TOP		=> 0,
										_Style_Alignment::VERTICAL_CENTER	=> 1,
										_Style_Alignment::VERTICAL_BOTTOM	=> 2,
										_Style_Alignment::VERTICAL_JUSTIFY	=> 3,
									  );
	/**
	...
	private static function _mapLocked($locked) {
		switch ($locked) {
			case _Style_Protection::PROTECTION_INHERIT:		return 1;
			case _Style_Protection::PROTECTION_PROTECTED:	return 1;
			case _Style_Protection::PROTECTION_UNPROTECTED:	return 0;
			default:												return 1;
		}
	}
	...
	private static function _mapHidden($hidden) {
		switch ($hidden) {
			case _Style_Protection::PROTECTION_INHERIT:		return 0;
			case _Style_Protection::PROTECTION_PROTECTED:	return 1;
			case _Style_Protection::PROTECTION_UNPROTECTED:	return 0;
			default:												return 0;
		}
