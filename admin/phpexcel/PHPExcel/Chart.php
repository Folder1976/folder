...
class _Chart
{
	 ...
	 * Create a new _Chart
	 */
	public function __construct($name, _Chart_Title $title = null, _Chart_Legend $legend = null, _Chart_PlotArea $plotArea = null, $plotVisibleOnly = true, $displayBlanksAs = '0', _Chart_Title $xAxisLabel = null, _Chart_Title $yAxisLabel = null)
	{
		$this->_name = $name;
		$this->_title = $title;
		$this->_legend = $legend;
	 ...
	 * Set Worksheet
	 *
	 * @param	_Worksheet	$pValue
	 * @throws	_Chart_Exception
	 * @return _Chart
	 */
	public function setWorksheet(_Worksheet $pValue = null) {
	 ...
	 * @return	_Chart
	 */
	public function setTitle(_Chart_Title $title) {
		$this->_title = $title;
	 ...
	 * @return	_Chart
	 */
	public function setLegend(_Chart_Legend $legend) {
		$this->_legend = $legend;
	 ...
	 * Set X-Axis Label
	 *
	 * @param	_Chart_Title $label
	 * @return	_Chart
	 */
	public function setXAxisLabel(_Chart_Title $label) {
	 ...
	 * @return	_Chart
	 */
	public function setYAxisLabel(_Chart_Title $label) {
	...
	public function render($outputDestination = null) {
		$libraryName = _Settings::getChartRendererName();
		...
		$libraryPath = _Settings::getChartRendererPath();
		...
		$rendererName = '_Chart_Renderer_'.$libraryName;
