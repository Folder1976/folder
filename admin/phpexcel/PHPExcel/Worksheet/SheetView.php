...
/**
 * _Worksheet_SheetView
 *
 * @category   
 * @package    _Worksheet
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Worksheet_SheetView
{
    ...
    /**
     * Create a new _Worksheet_SheetView
     */
	...
	public function setZoomScale($pValue = 100) {
		...
		if (($pValue >= 1) || is_null($pValue)) {
			...
			throw new _Exception("Scale must be greater than or equal to 1.");
		}
		return $this;
	}
	...
	public function setView($pValue = NULL) {
		...
		if (in_array($pValue, self::$_sheetViewTypes)) {
			...
			throw new _Exception("Invalid sheetview layout type.");
		}
