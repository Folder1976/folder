...
class _Worksheet_HeaderFooter
{
	 ...
	 *
	 * @var _Worksheet_HeaderFooterDrawing[]
	 */
	private $_headerFooterImages = array();

    /**
     * Create a new _Worksheet_HeaderFooter
     */
     ...
     *
     * @param _Worksheet_HeaderFooterDrawing $image
     * @param string $location
     * @throws _Exception
     * @return _Worksheet_HeaderFooter
     */
    public function addImage(_Worksheet_HeaderFooterDrawing $image = null, $location = self::IMAGE_HEADER_LEFT) {
     ...
     *
     * @param _Worksheet_HeaderFooterDrawing[] $images
     * @throws _Exception
     * @return _Worksheet_HeaderFooter
     */
    public function setImages($images) {
    	if (!is_array($images)) {
    		throw new _Exception('Invalid parameter!');
    	}
     ...
     *
     * @return _Worksheet_HeaderFooterDrawing[]
     */
