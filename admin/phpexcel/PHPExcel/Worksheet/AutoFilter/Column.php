...
/**
 * _Worksheet_AutoFilter_Column
 *
 * @category	
 * @package		_Worksheet
 * @copyright	Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Worksheet_AutoFilter_Column
{
	 ...
	 *
	 * @var array of _Worksheet_AutoFilter_Column_Rule
	 */
	...
	/**
	 * Create a new _Worksheet_AutoFilter_Column
	 *
	 *	@param	string		                   $pColumn		Column (e.g. A)
	 *	@param	_Worksheet_AutoFilter  $pParent		Autofilter for this column
	 */
	public function __construct($pColumn, _Worksheet_AutoFilter $pParent = NULL)
	{
	 ...
	 *
	 * @param _Worksheet_AutoFilter
	 * @return _Worksheet_AutoFilter_Column
	 */
	public function setParent(_Worksheet_AutoFilter $pParent = NULL) {
		$this->_parent = $pParent;
	...
	public function setFilterType($pFilterType = self::AUTOFILTER_FILTERTYPE_FILTER) {
		if (!in_array($pFilterType,self::$_filterTypes)) {
			throw new _Exception('Invalid filter type for column AutoFilter.');
		}
	...
	public function setJoin($pJoin = self::AUTOFILTER_COLUMN_JOIN_OR) {
		...
		if (!in_array($pJoin,self::$_ruleJoins)) {
			throw new _Exception('Invalid rule connection for column AutoFilter.');
		}
	 ...
	 *
	 * @throws	_Exception
	 * @return array of _Worksheet_AutoFilter_Column_Rule
	 */
	 ...
	 * @return	_Worksheet_AutoFilter_Column_Rule
	 */
	public function getRule($pIndex) {
		if (!isset($this->_ruleset[$pIndex])) {
			$this->_ruleset[$pIndex] = new _Worksheet_AutoFilter_Column_Rule($this);
		}
	...
	public function createRule() {
		$this->_ruleset[] = new _Worksheet_AutoFilter_Column_Rule($this);
	 ...
	 *
	 * @param	_Worksheet_AutoFilter_Column_Rule	$pRule
	 * @param	boolean	$returnRule 	Flag indicating whether the rule object or the column object should be returned
	 * @return	_Worksheet_AutoFilter_Column|_Worksheet_AutoFilter_Column_Rule
	 */
	public function addRule(_Worksheet_AutoFilter_Column_Rule $pRule, $returnRule=TRUE) {
