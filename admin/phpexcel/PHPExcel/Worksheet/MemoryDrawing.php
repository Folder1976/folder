...
/**
 * _Worksheet_MemoryDrawing
 *
 * @category   
 * @package    _Worksheet
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Worksheet_MemoryDrawing extends _Worksheet_BaseDrawing implements _IComparable
{
	/* Rendering functions */
    ...
    /**
     * Create a new _Worksheet_MemoryDrawing
     */
     ...
     * @return _Worksheet_MemoryDrawing
     */
     ...
     * @return _Worksheet_MemoryDrawing
     */
    public function setRenderingFunction($value = _Worksheet_MemoryDrawing::RENDERING_DEFAULT) {
     ...
     * @return _Worksheet_MemoryDrawing
     */
    public function setMimeType($value = _Worksheet_MemoryDrawing::MIMETYPE_DEFAULT) {
