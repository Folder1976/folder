 ...
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Worksheet_RowIterator implements Iterator
{
	/**
	 ...
	 *
	 * @param	_Worksheet	$subject	The worksheet to iterate over
	 * @param	integer				$startRow	The row number at which to start iterating
	 */
	public function __construct(_Worksheet $subject = null, $startRow = 1) {
		// Set subject
	...
	public function current() {
		return new _Worksheet_Row($this->_subject, $this->_position);
	}
