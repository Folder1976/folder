...
/**
 * _CachedObjectStorageFactory
 *
 * @category    
 * @package        _CachedObjectStorage
 * @copyright    Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _CachedObjectStorageFactory
{
     ...
     *
     * @return _CachedObjectStorage_ICache|NULL
     **/
    ...
    public static function getCacheStorageMethods()
    {
        ...
        foreach(self::$_storageMethods as $storageMethod) {
            $cacheStorageClass = '_CachedObjectStorage_' . $storageMethod;
    ...
    public static function initialize($method = self::cache_in_memory, $arguments = array())
    {
        ...
        $cacheStorageClass = '_CachedObjectStorage_'.$method;
        ...
        if (self::$_cacheStorageMethod === NULL) {
            self::$_cacheStorageClass = '_CachedObjectStorage_' . $method;
     ...
     *
     * @param    _Worksheet     $parent        Enable cell caching for this worksheet
     * @return    _CachedObjectStorage_ICache
     **/
    public static function getInstance(_Worksheet $parent)
    {
