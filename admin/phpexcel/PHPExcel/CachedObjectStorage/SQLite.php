...
/**
 * _CachedObjectStorage_SQLite
 *
 * @category   
 * @package    _CachedObjectStorage
 * @copyright  Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _CachedObjectStorage_SQLite extends _CachedObjectStorage_CacheBase implements _CachedObjectStorage_ICache {
	...
	protected function _storeData() {
		if ($this->_currentCellIsDirty) {
			...
			if (!$this->_DBHandle->queryExec("INSERT OR REPLACE INTO kvp_".$this->_TableName." VALUES('".$this->_currentObjectID."','".sqlite_escape_string(serialize($this->_currentObject))."')"))
				throw new _Exception(sqlite_error_string($this->_DBHandle->lastError()));
	...
	public function moveCell($fromAddress, $toAddress) {
		...
		if ($result === false)
			throw new _Exception($this->_DBHandle->lastErrorMsg());
	 ...
	 */
	public function __construct(_Worksheet $parent) {
