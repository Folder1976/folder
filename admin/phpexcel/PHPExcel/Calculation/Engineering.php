...
/**
 * _Calculation_Engineering
 *
 * @category	
 * @package		_Calculation
 * @copyright	Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Calculation_Engineering {
	...
	public static function BESSELI($x, $ord) {
		$x	= (is_null($x))	? 0.0 :	_Calculation_Functions::flattenSingleValue($x);
		$ord	= (is_null($ord))	? 0.0 :	_Calculation_Functions::flattenSingleValue($ord);
		...
		if ((is_numeric($x)) && (is_numeric($ord))) {
			...
			if (abs($x) <= 30) {
				$fResult = $fTerm = pow($x / 2, $ord) / _Calculation_MathTrig::FACT($ord);
				$ordK = 1;
				$fSqrX = ($x * $x) / 4;
				do {
					$fTerm *= $fSqrX;
			...
			return (is_nan($fResult)) ? _Calculation_Functions::NaN() : $fResult;
		}
	...
	public static function BESSELK($x, $ord) {
		...
		if ((is_numeric($x)) && (is_numeric($ord))) {
			...
			return (is_nan($fBk)) ? _Calculation_Functions::NaN() : $fBk;
		}
		return _Calculation_Functions::VALUE();
	}	//	function BESSELK()
	...
	public static function BESSELY($x, $ord) {
		...
		if ((is_numeric($x)) && (is_numeric($ord))) {
			...
			return (is_nan($fBy)) ? _Calculation_Functions::NaN() : $fBy;
		}
		return _Calculation_Functions::VALUE();
	}	//	function BESSELY()
	...
	public static function BINTOHEX($x, $places=NULL) {
		$x	= _Calculation_Functions::flattenSingleValue($x);
		$places	= _Calculation_Functions::flattenSingleValue($places);
	...
	public static function COMPLEX($realNumber=0.0, $imaginary=0.0, $suffix='i') {
		$realNumber	= (is_null($realNumber))	? 0.0 :	_Calculation_Functions::flattenSingleValue($realNumber);
		$imaginary	= (is_null($imaginary))		? 0.0 :	_Calculation_Functions::flattenSingleValue($imaginary);
		$suffix		= (is_null($suffix))		? 'i' :	_Calculation_Functions::flattenSingleValue($suffix);
	...
	public static function IMAGINARY($complexNumber) {
		$complexNumber	= _Calculation_Functions::flattenSingleValue($complexNumber);
	...
	public static function IMPOWER($complexNumber,$realNumber) {
		$complexNumber	= _Calculation_Functions::flattenSingleValue($complexNumber);
		$realNumber		= _Calculation_Functions::flattenSingleValue($realNumber);
	...
	public static function IMDIV($complexDividend,$complexDivisor) {
		$complexDividend	= _Calculation_Functions::flattenSingleValue($complexDividend);
		$complexDivisor	= _Calculation_Functions::flattenSingleValue($complexDivisor);
	...
	public static function IMSUB($complexNumber1,$complexNumber2) {
		$complexNumber1	= _Calculation_Functions::flattenSingleValue($complexNumber1);
		$complexNumber2	= _Calculation_Functions::flattenSingleValue($complexNumber2);
	...
	public static function GESTEP($number, $step=0) {
		...
		$step	= _Calculation_Functions::flattenSingleValue($step);
	 ...
	 *			 follows Excel 2010 behaviour, and accepts nagative arguments.
	 *
	 *	Excel Function:
	 *		ERF(lower[,upper])
	 *
	...
	public static function ERF($lower, $upper = NULL) {
		$lower	= _Calculation_Functions::flattenSingleValue($lower);
		$upper	= _Calculation_Functions::flattenSingleValue($upper);
	...
	public static function CONVERTUOM($value, $fromUOM, $toUOM) {
		...
		$fromUOM	= _Calculation_Functions::flattenSingleValue($fromUOM);
		$toUOM		= _Calculation_Functions::flattenSingleValue($toUOM);
