...
class _Chart_DataSeries
{
	 ...
	 * Plot Label
	 *
	 * @var array of _Chart_DataSeriesValues
	 */
	...
	/**
	 * Create a new _Chart_DataSeries
	 */
	public function __construct($plotType = null, $plotGrouping = null, $plotOrder = array(), $plotLabel = array(), $plotCategory = array(), $plotValues = array(), $smoothLine = null, $plotStyle = null)
	{
		...
		if ((count($plotLabel) == 0) || (is_null($plotLabel[$keys[0]]))) {
			$plotLabel[$keys[0]] = new _Chart_DataSeriesValues();
		}

		$this->_plotLabel = $plotLabel;
		if ((count($plotCategory) == 0) || (is_null($plotCategory[$keys[0]]))) {
			$plotCategory[$keys[0]] = new _Chart_DataSeriesValues();
		}
	 ...
	 * Get Plot Labels
	 *
	 * @return array of _Chart_DataSeriesValues
	 */
