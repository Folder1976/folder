...
/**
 * _Chart_DataSeriesValues
 *
 * @category	
 * @package		_Chart
 * @copyright	Copyright (c) 2006 - 2013  (http://www.codeplex.com/)
 */
class _Chart_DataSeriesValues
{
	...
	/**
	 * Create a new _Chart_DataSeriesValues object
	 */
	 ...
	 *								Typical values are:
	 *									_Chart_DataSeriesValues::DATASERIES_TYPE_STRING
	 *										Normally used for axis point values
	 *									_Chart_DataSeriesValues::DATASERIES_TYPE_NUMBER
	 *										Normally used for chart data values
	 * @return	_Chart_DataSeriesValues
	 */
	public function setDataType($dataType = self::DATASERIES_TYPE_NUMBER) {
		if (!in_array($dataType, self::$_dataTypeValues)) {
    		throw new _Chart_Exception('Invalid datatype for chart data series values');
		}
	...
	public function setDataValues($dataValues = array(), $refreshDataSource = TRUE) {
		$this->_dataValues = _Calculation_Functions::flattenArray($dataValues);
	...
	public function refresh(_Worksheet $worksheet, $flatten = TRUE) {
        if ($this->_dataSource !== NULL) {
        	$calcEngine = _Calculation::getInstance($worksheet->getParent());
			$newDataValues = _Calculation::_unwrapResult(
			...
			if ($flatten) {
				$this->_dataValues = _Calculation_Functions::flattenArray($newDataValues);
				...
				$dimensions = _Cell::rangeDimension(str_replace('$','',$cellRange));
