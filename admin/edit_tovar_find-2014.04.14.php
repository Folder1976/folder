...
$tQuery = "SELECT " . $Fields . " 
	  FROM `tbl_tovar`,`tbl_warehouse_unit`".$table.",`tbl_parent` 
	  WHERE 
...
//==========================SHOP==========================================================
echo "",$m_setup['menu shop'],"<br>",$m_setup['menu parent'],"
...
echo "</select><br>";
//==========================PARENT============================================================
echo "<select name='_parent' style='width:350px' onChange='submit();'>";
    $count=0;
...
$id_tmp=mysql_result($ver,$count,"tovar_id");
  ...
  $count ",$id_tmp," ",$m_setup['menu history'],"&nbsp;</a>";
...
//=================FROM====================================================================================================
  echo "<td style='border-bottom:1px solid'><select name='operation_detail_from*",$id_tmp,"' class=\"nak_field_warehouse_from\" id='from_" , $id_tmp, "' style='width:100px' onChange='setcolorfrom(" ,$id_tmp, "," , mysql_num_rows($warehouse) ,",1)'>";# OnChange='submit();'>";
    $count1=0;
    while ($count1 < mysql_num_rows($warehouse))
    {
    echo "\n<option ";
...
//=====================================================================================================================
  ...
  echo "<td>";
  echo "<input type='text' id='price_info_",$id_tmp,"' value='non' class=\"nak_field_$i\" style='font-size:x-small;width:100px;'/>";
  echo "<select class=\"nak_field_$i\" style='font-size:x-small;width:100px' id='price_",$id_tmp,"' onChange='setprice(this.value,",$id_tmp,")'>";# OnChange='submit();'>";
    $count1=0;
...
//  echo "</td>";
 ...
 // echo "</td>";
  ...
  echo "<td id=\"" , mysql_result($ver,$count,"tovar_id") , "_" , mysql_result($warehouse,$warehouse_count,"warehouse_id")  , "\"
	  ...
	  align=\"center\">";
	  //width=", 100 / mysql_num_rows($warehouse) ,"%>";  
