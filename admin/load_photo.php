...
/*  
  $dir = "/hosting/b18149151/data/www/folder.com.ua";
...
if (is_dir($dir)) {
    if ($dh = opendir($dir)) {
        while (($file = readdir($dh)) !== false) {
            print "<br><a href='load_photo.php?dir=".$dir."/".$file."'>[" . filetype($dir . $file) . "]  $file  </a>\n";
        }
        closedir($dh);
    }
}
...
if($_REQUEST['type']=="parent") header ('Refresh: 0; url=edit_parent_inet.php?parent_inet_id=' . $_REQUEST["tovar_id"]);
if($_REQUEST['type']=="tovar") header ('Refresh: 0; url=edit_tovar.php?tovar_id=' . $_REQUEST["tovar_id"]);
